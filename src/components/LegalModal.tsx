...
const PRIVACIDADE_TEXT = (
  <>
    ...
    <p>A Alpha Convênios coleta informações estritamente necessárias para a elaboração de cotações de planos de saúde, incluindo dados pessoais básicos de contato (nome, telefone, e-mail) e informações demográficas básicas (faixa etária, profissão), em plena conformidade com a LGPD (Lei nº 13.709/2018).</p>
...
const TERMOS_TEXT = (
  <>
    ...
    <p>A Alpha Convênios atua como corretora independente autorizada, oferecendo análise consultiva e cotação de planos de saúde e odontológicos.</p>
    ...
    <p>Logotipos das operadoras de saúde são de suas respectivas marcas. O design, textos originais e componentes deste site são propriedade intelectual da Alpha Convênios.</p>
  </>
)
